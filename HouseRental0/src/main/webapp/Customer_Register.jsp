                ...
                <ul class="navbar-nav">
                 ...
                 <div class="bordering" id="buttons">
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      <li><a class="dropdown-item" href="register.jsp">House Owner Register</a></li>
            ...
            <form action="Customer_Registration" method="post">
                ...
                <label>
                    <div style="margin-left: 951.5px;">
                        <input type="checkbox" name="submit" value="customer_register" checked="checked" name="remember"> Remember me
                    </div>
                </label>
