...
<div id="id01">
  <form class="modal-content" action="update1">
      <h1>Update House Details</h1>
      <p>Please fill this form to update house details.</p>
      <hr>
      ...
      <label for="hdescrip"><b>House cost</b></label>
      <input type="text" placeholder="Enter house cost" name="hcost" required><br>
      
      <label for="hdescrip"><b>House Month</b></label>
      <input type="text" placeholder="Enter monthly rent" name="hmonth" required><br>
      
      <label for="hdescrip"><b>House security</b></label>
      <input type="text" placeholder="Enter security cost" name="hsecurity" required><br>
