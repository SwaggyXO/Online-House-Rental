                ...
                <ul class="navbar-nav">
                 ...
                 <div class="bordering" id="buttons">
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      <li><a class="dropdown-item" href="HouseOwnerLogin.jsp">House Owner Register</a></li>
                      <li><a class="dropdown-item" href="CustomerLogin.jsp">Customer Register</a></li>
                    </ul>
                  </li>
                </div>
                </ul>
          ...
          <div>
            <form action="Admin.jsp" method="post">
                ...
                <div class="container">
                  ...
                  <button type="submit" style="width: 50%; margin-left: 320px;">Login</button>
                </div>
                <label>
                    <div style="margin-left: 951.5px;">
                        <input type="checkbox" name="submit" value="admin_login" checked="checked" name="remember"> Remember me
                    </div>
                </label>
