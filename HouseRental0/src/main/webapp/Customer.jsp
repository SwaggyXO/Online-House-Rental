...
<html>
    ...
    <body style="background-color: rgb(48, 48, 48)">
        <div class="w3-sidebar w3-bar-block bg-black w3-sepia-max w3-animate-right" style="display:none;right:0;" id="rightMenu">
            ...
            <a href="Customer.jsp" class="w3-bar-item w3-button" id="nav-buttons">Home</a>
            <a href="Customer_View" class="w3-bar-item w3-button" id="nav-buttons">Rent</a>
            <a href="Customer.jsp" class="w3-bar-item w3-button" id="nav-buttons">Login</a>
          </div>
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    ...
                    <a class="nav-link active" aria-current="page" href="Customer.jsp">Home</a>
                    </div>
                  </li>
                  <li class="nav-item">
                    <div class="bordering" id="buttons">
                    <a class="nav-link" href="Customer_View">Rent</a>
                    </div>
                  </li>
                  <div class="bordering" id="buttons">
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      <li><a class="dropdown-item" href="Customer.jsp">Customer Login</a></li>
                    </ul>
                  </li>
                 </div>
                 <div class="bordering" id="buttons">
                ...
                <div class="bordering" id="buttons">
                    <a class="nav-link" href="UpdateProf.jsp">Update Profile</a>
                    </div>
            <div>
