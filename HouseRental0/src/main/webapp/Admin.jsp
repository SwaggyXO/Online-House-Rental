...
<html>
    ...
    <body style="background-color: rgb(48, 48, 48)">
        <div class="w3-sidebar w3-bar-block bg-black w3-sepia-max w3-animate-right" style="display:none;right:0;" id="rightMenu">
            ...
            <a href="Admin.jsp" class="w3-bar-item w3-button" id="nav-buttons">Home</a>
            <a href="CustomerLogin.jsp" class="w3-bar-item w3-button" id="nav-buttons">Rent</a>
            <a href="Admin.jsp" class="w3-bar-item w3-button" id="nav-buttons">Login</a>
            <a href="Admin_Edit" class="w3-bar-item w3-button" id="nav-buttons">Edit</a>
          </div>
        <nav class="navbar navbar-expand-lg navbar-dark bg-black">
            <div class="container-fluid" id="maindiv">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    <div class = "bordering" id="buttons">
                    <a class="nav-link active" aria-current="page" href="Admin_Edit">Edit</a>
                    </div>
                </ul>
              </div>
            </div>
